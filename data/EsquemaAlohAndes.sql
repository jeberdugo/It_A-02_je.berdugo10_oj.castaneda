...
CREATE TABLE RESERVA
	...
	FECHA_REALIZACION DATE,
        CLIENTE_ID NUMBER,
	RESERVA_COLECTIVA_ID NUMBER);

-- Creacion de la tabla RESERVA_COLECTIVA
...
ALTER TABLE RESERVA_COLECTIVA ADD PRIMARY KEY (ID);
...
ALTER TABLE RESERVA ADD CONSTRAINT FK_RESERVA_R_C_ID FOREIGN KEY (RESERVA_COLECTIVA_ID) REFERENCES RESERVA_COLECTIVA(ID);

ALTER TABLE RESERVA MODIFY ESTADO NOT NULL;
ALTER TABLE RESERVA MODIFY VALOR_TOTAL NOT NULL;
ALTER TABLE RESERVA MODIFY FECHA_REALIZACION NOT NULL;
...
-- Restricciones de la tabla RESERVA_COLECTIVA
ALTER TABLE RESERVA_COLECTIVA MODIFY VALOR_TOTAL NOT NULL;

ALTER TABLE RESERVA_COLECTIVA ADD CONSTRAINT CK_R_C_VALOR_TOTAL CHECK (VALOR_TOTAL >-1);
...
ALTER TABLE ALOJAMIENTO MODIFY HABILITADO NOT NULL;
...
ALTER TABLE ALOJAMIENTO ADD CONSTRAINT CK_ALOJAMIENTO_HABILITADO CHECK (HABILITADO >-1 AND HABILITADO<2);
